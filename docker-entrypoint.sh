...
docker_setup_env() {
  ...
  if [[ "${MCL}" == "1" ]]; then
      export LIB_MANTICORE_COLUMNAR="/var/lib/manticore/mcl/lib_manticore_columnar.so"
      export LIB_MANTICORE_SECONDARY="/var/lib/manticore/mcl/lib_manticore_secondary.so"
