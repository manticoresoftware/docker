...
RUN  wget  https://github.com/manticoresoftware/manticoresearch/releases/download/3.1.0/manticore_3.1.0-190716-445e806e-release.stretch_amd64-bin.deb \
    && dpkg -i manticore_3.1.0-190716-445e806e-release.stretch_amd64-bin.deb \
