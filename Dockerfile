...
RUN set -x \
	...
	&& gosu nobody true \
        && wget  https://github.com/manticoresoftware/manticoresearch/releases/download/3.4.0/manticore_3.4.0-200326-0686d9f0-release.stretch_amd64-bin.deb \
        && dpkg -i manticore_3.4.0-200326-0686d9f0-release.stretch_amd64-bin.deb \
